...
export function SocialButton({ platform, href, children }: SocialButtonProps) {
  const bgColor = platform === "twitter" ? "bg-[#1DA1F2] hover:bg-[#1a94e0]" : "bg-[#5865F2] hover:bg-[#4a56e3]"
  ...
  return (
    <a
      ...
      className={`flex items-center justify-center gap-2 w-full py-3 px-4 rounded-lg text-white font-medium transition-all ${bgColor}`}
    >
      {platform === "twitter" ? (
        <svg
